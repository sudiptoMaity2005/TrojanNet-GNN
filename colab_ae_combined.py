# ==============================================================================
# COLAB SCRIPT FOR UNSUPERVISED AUTOENCODER TRAINING (COMBINED RS232 + AES)
# ==============================================================================
...
def train_autoencoder(train_loader, test_loader, model_class, epochs=100):
    print(f"\n--- Unsupervised Anomaly Detection ({model_class.__name__}) (Combined RS232+AES) ---")
...
if __name__ == "__main__":
    ...
    print("Loading RS232 and AES Split Circuits for Autoencoder...")
    ...
    print("\nSaving Combined Autoencoder Models...")
    torch.save(mlp_ae.state_dict(), "combined_mlp_ae.pth")
    torch.save(gcn_ae.state_dict(), "combined_gcn_ae.pth")
    torch.save(gat_ae.state_dict(), "combined_gat_ae.pth")
    print("Saved combined_mlp_ae.pth, combined_gcn_ae.pth, combined_gat_ae.pth successfully!")
