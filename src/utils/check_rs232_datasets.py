...
def check_rs232_datasets():
    node_dir = "/Users/sudiptomaity/projects/TrojanNet-GNN/rs232_output_datasets"
    edge_dir = "/Users/sudiptomaity/projects/TrojanNet-GNN/rs232_edges_datasets"
    ...
    print("==================================================")
    print(f"STARTING ULTIMATE ANOMALY CHECK ACROSS {total_files} RS232 DATASETS")
    print("==================================================")
    
    for file in sorted(node_files):
        node_path = os.path.join(node_dir, file)
        edge_filename = file.replace("dataset_RS232", "edges_RS232")
