# ==============================================================================
# COPY THIS ENTIRE SCRIPT INTO A GOOGLE COLAB NOTEBOOK CELL AND RUN IT (FOR AES)
# ==============================================================================
...
def train_inductive(train_loader, test_loader, model_class, epochs=100):
    print(f"\n--- Training on All AES Circuits (80/20 split) ({model_class.__name__}) ---")
...
if __name__ == "__main__":
    ...
    print("\nAES Training completely finished!")
    
    print("\nSaving Models...")
    torch.save(gcn_induct.state_dict(), "aes_gcn_model.pth")
    torch.save(gat_induct.state_dict(), "aes_gat_model.pth")
    print("Saved aes_gcn_model.pth and aes_gat_model.pth successfully!")
