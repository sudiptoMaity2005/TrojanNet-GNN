# ==============================================================================
# COLAB SCRIPT FOR UNSUPERVISED AUTOENCODER TRAINING (RS232)
# ==============================================================================
...
if __name__ == "__main__":
    ...
    print("Building PyTorch Geometric Graph Objects for Train Set (RS232)...")
    ...
    print("Building PyTorch Geometric Graph Objects for Test Set (RS232)...")
    ...
    print("\nSaving RS232 Autoencoder Models...")
    torch.save(mlp_ae.state_dict(), "rs232_mlp_ae.pth")
    torch.save(gcn_ae.state_dict(), "rs232_gcn_ae.pth")
    torch.save(gat_ae.state_dict(), "rs232_gat_ae.pth")
    print("Saved rs232_mlp_ae.pth, rs232_gcn_ae.pth, rs232_gat_ae.pth successfully!")
